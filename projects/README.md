...
| `lifewake/` | 生命回响：惊喜盲盒 + 心跳音乐 + 时空记忆匣 Memory P1 | `python projects/lifewake/scripts/evaluate_lifewake_mvp.py` ；`python projects/lifewake/scripts/run_memory_chest_demo.py` |
