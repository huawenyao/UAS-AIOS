...
| [PRODUCT_ESSENCE_CARRIER_AND_TECH](./PRODUCT_ESSENCE_CARRIER_AND_TECH.md) | 本质价值与单点击穿、载体形态（仪式壳+主权核）、礼物病毒、技术标准与逻辑架构 |
| [BETA_SHELL_AND_GIFT_SPEC](./BETA_SHELL_AND_GIFT_SPEC.md) | Beta Ritual Shell IA、单人/双人/礼物击穿路径、GiftToken 与落地验收 |
...
| 资产 | 用途 |
|---|---|
| [MVP_ACCEPTANCE_CASES](./MVP_ACCEPTANCE_CASES.md) | CASE-001～017：成功、低 wow、慢灵感、共享撤回、未成年人、断连、反馈演化、礼物铸造/解析/级联撤回 |
...
2. CASE-001～017 均有确定终态、错误/延期码、审计与下一步。
