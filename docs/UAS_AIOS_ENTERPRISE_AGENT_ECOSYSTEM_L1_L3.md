...
- **当前实现边界**：仓库已有 ASUI、sub uas app、运行时与 Πpaw/UAS-S 的参考实现；selfpaw/UAS-U 仍主要是方法论、模板与示例级能力，尚未形成平台级 U 层运行时。详见 [理念体系与产品/技术架构一致性检查](./THEORY_ARCHITECTURE_CONSISTENCY_AUDIT.md)。
