...
| 2. 模拟 | simulation（可选，可配 `script`） | ✅ 最小实现 | `scripts/value_loop_snapshot.py`；Sales OS 见 `run_simulation_snapshot.py` |
...
| 7. 收益 | evolution 读 `revenue_feedback` | ⏳ 草案 | `configs/value_metrics.sample.json` + `database/value_feedback/` |
